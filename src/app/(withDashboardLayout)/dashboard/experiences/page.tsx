        ...
        <Stack boxShadow={24} p={2} borderRadius={2}>
          ...
          >
            <Grid container spacing={1}>
              <Grid item xs={12}>
                <REInput label="Job Title" name="title" />
              </Grid>
              <Grid item xs={12}>
                <REInput label="Organization Name" name="organization" />
              </Grid>
              <Grid item xs={12}>
                <REInput label="Organization Site Link" name="link" />
              </Grid>
              <Grid item xs={12}>
        ...
        {isEduLoading ? (
          ...
          <Grid container spacing={2}>
            {data?.data?.map((exp: IExperience) => (
              <Grid item key={exp._id} xs={12} md={6}>
                <Stack
                  p={2}
                  boxShadow={12}
                  gap={0.5}
